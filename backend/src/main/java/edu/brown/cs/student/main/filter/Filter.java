...
public class Filter {
    ...
    public static boolean dateCheck(List<String> potentialDates) throws ParseException {
        ...
        boolean beginningValid = firstAllowedDate.before(firstPotentialDate) || firstAllowedDate.compareTo(firstPotentialDate) == 0;
        boolean endingValid = secondAllowedDate.after(secondPotentialDate) || secondAllowedDate.compareTo(secondPotentialDate) == 0;
...
//                    && dateCheck(dateList) // Uncomment this when we have the correct date format given
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(f.dateCheck(potList));
    }
