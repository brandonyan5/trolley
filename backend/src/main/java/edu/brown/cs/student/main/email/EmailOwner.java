...
public class EmailOwner {
    ...
    public static boolean sendEmailToOwnerOnDecision(String ownerEmail) throws MessagingException {
    ...
    public static boolean sendEmailToOwnerOnUnclaim(String ownerEmail) throws MessagingException {
        Properties prop = new Properties();
        prop.put("mail.smtp.auth", "true");
        prop.put("mail.smtp.starttls.enable", "true");
        prop.put("mail.smtp.host", "smtp.gmail.com");
        ...
        try {
            ...
            String msg = "Your listing was cancelled and placed back on the marketplace.";
